...
const Footer: FunctionComponent<FooterProps> = () => {
  return (
    ...
    >
      ...
      <div className="text-center text-xs p-2">© {new Date().getFullYear()} All Rights Reserved. Designed & Coded with ❤️️ by <a target="_blank" href="https://www.mnabeel.in/">mnabeel.in</a></div>
    </footer>
  );
};
